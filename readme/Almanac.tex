...
\begin{noSepEnumerate}
	...
	\item Hard is the path that l\notch{i}es ahead of you, the weak will be eliminated
	\item Each key unlocks a gate, the gate doesn't bud\notch{g}e without the key.
	\item Absorb each li\notch{n}e completely, Words and rhymes have power
	\item The hunt may feature elements from various games, treasure hunts, f\notch{i}lms and books; Being familiar with them gains you an edge
	\item Every inch of the almanac is impor\notch{t}ant, decode it entirely and you'll be ahead of everyone else
	\item Read the book Ready Player One to have some background on the game
	\item Pay attention to deta\notch{i}l, for example, you should have noticed that the third pointer was the only one with a period at its end
	\item A textbox will only take in l\notch{o}wer case letters, digits and symbols, no upper case or spaces
	\item Remember that hacks and cheats don't work a\notch{n}d may lead to a ban
