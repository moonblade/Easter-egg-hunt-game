...
% First \white{c}of \white{h}all \white{e}you're \white{a}now \white{t}an \white{e}Egg \white{x}Hunter, \white{t}or \white{e}for \white{n}short, \white{d}a \white{s}Gunter. Congratulations.
